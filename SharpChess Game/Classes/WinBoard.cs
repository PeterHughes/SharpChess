// --------------------------------------------------------------------------------------------------------------------
// <copyright file="WinBoard.cs" company="SharpChess">
//   Peter Hughes
// </copyright>
// <summary>
...
namespace SharpChess
{
    ...
    public class WinBoard
    {
        ...
        /// The m_bln active.
        /// </summary>
        private static bool m_blnActive;

        /// <summary>
        /// The m_thread win board listener.
        /// </summary>
        private static Thread m_threadWinBoardListener;
        ...
        /// <summary>
        /// Gets a value indicating whether ShowGUI.
        /// </summary>
        ...
        public static Thread threadListener
        {
            get
            {
                return m_threadWinBoardListener;
            }
        }
        ...
        public static void SendAnalyzeStatus(TimeSpan ThinkingTime, int Nodes, int Ply, int MovesRemaining, int TotalMoves, Move moveCurrent)
        {
            ...
            */
            if (m_blnActive && Game.IsInAnalyseMode)
            {
                ...
                SendOutputMessage("stat01:" + " " + intTimeIncentiseconds.ToString() + " " + Nodes.ToString() + " " + Ply.ToString() + " " + MovesRemaining.ToString() + " " + TotalMoves.ToString() + " " + moveCurrent.From.Name + moveCurrent.To.Name);
            }
        }
        ...
        public static void SendThinking(int Ply, int Score, TimeSpan ThinkingTime, int Nodes, string PrinicalVariation)
        {
            ...
            */
            if (m_blnActive && Game.ShowThinking)
            {
                ...
                int intTimeIncentiseconds = Convert.ToInt32(ThinkingTime.TotalMilliseconds / 100);
                SendOutputMessage(Ply.ToString() + " " + intScoreInCentipawns.ToString() + " " + intTimeIncentiseconds.ToString() + " " + Nodes.ToString() + " " + PrinicalVariation);
            }
        }
        ...
        public static void StartListener()
        {
            if (m_blnActive)
            {
                m_threadWinBoardListener = new Thread(Listen);
                m_threadWinBoardListener.Priority = ThreadPriority.Normal;
